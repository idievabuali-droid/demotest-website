  ...
  *  hidden?: boolean,      // if true (and sourceId is set), hide base product
  ...
  { id: "pb-20000-dual", name: "Power Bank 20,000 mAh – Dual", sku: "PB-20K-DUAL", category: "Power Banks", price: 16.5, specs: ["20,000 mAh","Dual","PD/QC"], description: "20k dual output.", image: "Изображение WhatsApp 2025-08-16 в 15.37.19_3b58c17b.jpg", variants: { Capacity: ["20,000 mAh"], Ports: ["USB‑C + USB‑A"], Standard: STANDARDS } },
    ...
    function useBodyScrollLock(active, preferredScrollRef){
      ...
      const prefersPassiveLock = useMemo(() => {
        ...
        const isIOSOpera = /OPiOS/i.test(ua);
        return isAppleDevice || isIOSChrome || isIOSFirefox || isIOSEdge || isIOSOpera;
      }, []);
      ...
      useLayoutEffect(() => {
        ...
        previousStylesRef.current = {
          strategy: prefersPassiveLock ? 'passive' : 'fixed',
          position: body.style.position,
          top: body.style.top,
          width: body.style.width,
          overflow: body.style.overflow,
          touchAction: body.style.touchAction,
          webkitOverflowScrolling: body.style.webkitOverflowScrolling,
          overscroll: body.style.overscrollBehavior,
          overscrollY: body.style.overscrollBehaviorY,
          htmlOverflow: html.style.overflow,
          htmlOverscroll: html.style.overscrollBehavior,
        };

        if (prefersPassiveLock) {
          ...
          return () => {
            ...
            body.style.webkitOverflowScrolling = prev.webkitOverflowScrolling || '';
            body.style.overscrollBehavior = prev.overscroll || '';
            body.style.overscrollBehaviorY = prev.overscrollY || '';
      ...
      }, [active, preferredScrollRef, prefersPassiveLock]);
    }
